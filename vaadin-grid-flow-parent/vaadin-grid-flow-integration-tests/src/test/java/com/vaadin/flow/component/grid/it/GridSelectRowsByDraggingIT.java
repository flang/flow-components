 ...
 */
@TestPath("vaadin-grid/grid-select-rows-by-dragging")
public class GridSelectRowsByDraggingIT extends AbstractComponentIT {
    ...
    public void init() {
        ...
        grid = $(GridElement.class).id(
                GridSelectRowsByDraggingPage.SELECT_ROWS_BY_DRAGGING_GRID_ID);
    }
    ...
    public void toggle_enabled_selectRowsByDragging() {
        ...
        String selectRowsByDragging = gridSelectionMode
                .getAttribute("selectRowsByDragging");
        Assert.assertFalse("selectRowsByDragging should be false",
        ...
        Assert.assertTrue("selectRowsByDragging should be true",
                Boolean.parseBoolean(selectRowsByDragging));
    }
    ...
    private void enableSelectRowsByDragging() {
        CheckboxElement checkbox = $(CheckboxElement.class).id(
                GridSelectRowsByDraggingPage.TOGGLE_SELECT_ROWS_BY_DRAGGING_CHECKBOX);
        checkbox.click();
    }
